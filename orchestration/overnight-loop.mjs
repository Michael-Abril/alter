...
const AKASH_ML_API_KEY = process.env.AKASH_ML_API_KEY;
const DEFAULT_MODEL = 'meta-llama/Llama-3.3-70B-Instruct'; // Akash ML model
...
export async function runOvernightLoop(config, options = {}) {
  ...
  const apiKey = options.apiKey || AKASH_ML_API_KEY;
